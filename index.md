...
I am a junior **Computer Engineer** student at **San Jose State University**, with the aspirations to get into the **Tech / Engineering field**, focused on Digital Signal Processing, Low level coding, and embedded systems. My work bridges the gap between theoretical mathematics (like DTFT) and real-world hardware implementation.
...
| Class | About | knowledge Gained |
| :--- | :--- | :--- |
| **Kinematics** | West Valley College | Analyzed the laws of motion, force, and energy to predict the behavior of physical objects.  |
| **Electrical and Magnetic Physics** | West Valley College | Explored electric fields, circuits, and Maxwell’s equations to understand electromagnetism.  |
| **Introduction to Electrodynamics** | David Griffiths | Advanced study of electromagnetic radiation, potential theory, and field interactions.  |
...
| **Psychological in Sport** | West Valley College | Learned strategies for peak performance, mental resilience, and high-stakes team dynamics.  | 
